        ...
        try {
            ...
            if (!$method->isStatic()) {
                ...
                if (
                        ...
                        && strpos($controllerName, "Controllers_WP") === 0
                        && $controllerName !== "Controllers_WPAuthenticate"
...
//        header('Access-Control-Allow-Origin: https://test.fintoolbox.nl/');
        ...
        header('Access-Control-Allow-Headers: Content-Type,Authorization,X-Requested-With,cardapikey,auth_user,auth_pw');
    }
